# ==============================================================================
# title              : main_app.py
# description        : This is the flask app for BERT QNA TURKISH DEMO which receives the request and provide response.
...
# json_json() function is used to convert the input data i.e paragraph and question into the SQUAD like format, then we will be storing this data in a file named input_turkish.json which is used as prediction file in run_squad command that you will see further in submitted_form() function.
...
def submitted_form():
    ...
    if request.method == 'POST':
        ...
        with open('input_turkish.json', 'w') as f:
  ...
  --predict_file=input_turkish.json \
  --init_checkpoint=bert/model/turkish_fuzzy_model.ckpt-17991 \
  --do_lower_case=False \
  --max_seq_length=384 \
  --doc_stride=128 \
  --do_train=False \
...
def submitted_api():
  ...
  --init_checkpoint=bert/turkish_fuzzy_model.ckpt-17991 \
  --do_lower_case=False \
  --max_seq_length=384 \
  --doc_stride=128 \
  --do_train=False \
